...
import 'task_event.dart' as _i5;
import 'package:todo_server/src/generated/task.dart' as _i6;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i5.TaskEvent) {
      return _i5.TaskEvent.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i5.TaskEvent?>()) {
      return (data != null ? _i5.TaskEvent.fromJson(data) : null) as T;
    }
    if (t == List<_i6.Task>) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'TaskEvent') {
      return deserialize<_i5.TaskEvent>(data['data']);
    }
